    ...
    <div className="bg-[#FFFFFF]">
      <div className="max-w-[90%] mx-auto py-3 flex items-center justify-between font-inter">
        ...
        >
          ...
          >
            <a
              href="https://github.com/Nandha1616?tab=repositories" target="_blank"
              className="  hover:text-[#fe5617] "
            >
              <FaGithub size={29} />
            </a>
            <a
              href="https://www.linkedin.com/in/nandha-kumar-m-48aaa9306" target="_blank"
              className="hover:text-[#fe5617]"
            >
              <FaLinkedin size={29} />
            </a>
            <a
              href="https://www.instagram.com/mr_kuttan_16/?next=%2F&hl=en" target="_blank"
              className="hover:text-[#fe5617]"
            >
              <FaInstagram size={29} />
            </a>
        ...
        <div className="hidden lg:flex w-[100px] items-center justify-between">
          <a
            href="https://github.com/Nandha1616?tab=repositories"
            className="hover:text-[#fe5617]"
          >
            <FaGithub size={29} />
          </a>
          <a
            href="https://www.linkedin.com/in/nandha-kumar-m-48aaa9306"
            className="hover:text-[#fe5617]"
          >
            <FaLinkedin size={29} />
          </a>
          <a
            href="https://www.instagram.com/mr_kuttan_16/?next=%2F&hl=en"
            className="hover:text-[#fe5617]"
          >
            <FaInstagram size={29} />
          </a>
